        ...
        // output data of each row
          while($row = $result->fetch_assoc()) {
            echo '<div class="post-images container">';
              echo '<img class="user-image image" src="../uploaded-pictures/'.$row["imagename"].'" onerror="this.onerror=null; this.src=\'../uploaded-pictures/noimage2.png\'" alt="User\'s image">';
              echo '<div class="hover-image-container overlay">';
